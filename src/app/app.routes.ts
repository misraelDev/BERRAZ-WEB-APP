...
export const routes: Routes = [
  {
    ...
    children:[
      ...
      },
      {
        ...
        title: 'Inicio | TailAdmin - Angular Admin Dashboard Template',
      },
      {
        path: 'clients',
        component: ClientsComponent,
        title: 'Clientes | TailAdmin - Angular Admin Dashboard Template',
      },
      {
        path: 'appointments',
        component: AppointmentsComponent,
        title: 'Agenda | TailAdmin - Angular Admin Dashboard Template',
      },
      {
        path: 'appointments/add',
        component: AddAppointmentComponent,
        title: 'Agregar Cita | TailAdmin - Angular Admin Dashboard Template',
      },
      {
        path:'calendar',

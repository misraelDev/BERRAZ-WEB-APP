...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M11.03 2.59C11.3239 2.29504 11.7988 2.29504 12.0927 2.59L20.4097 10.907C20.7047 11.201 20.7047 11.6759 20.4097 11.9698C20.1148 12.2638 19.6399 12.2638 19.3459 11.9698L19.5 12.1239V19C19.5 19.4142 19.1642 19.75 18.75 19.75H14.25C13.8358 19.75 13.5 19.4142 13.5 19V15C13.5 14.5858 13.1642 14.25 12.75 14.25H11.25C10.8358 14.25 10.5 14.5858 10.5 15V19C10.5 19.4142 10.1642 19.75 9.75 19.75H5.25C4.83579 19.75 4.5 19.4142 4.5 19V12.1239L4.65414 11.9698C4.35918 11.6759 4.35918 11.201 4.65414 10.907L11.03 2.59ZM6 10.3719V18.25H9V14.25C9 13.4318 9.63178 12.75 10.5 12.75H13.5C14.3682 12.75 15 13.4318 15 14.25V18.25H18V10.3719L12 4.37193L6 10.3719Z" fill="currentColor"></path></svg>`,
      name: "Home",
      path: "/home",
    },
    {
    ...
    },
    {
      ...
      subItems: [
        ...
        { name: "Agregar cita", path: "/appointments/add" },
      ],
    },
    {
